...
@ModelActor
public actor SwiftDataDocumentRepository: DocumentRepository {
    public func fetchAll() async throws -> [DocumentEntity] {
    ...
    public func fetchByID(_ id: UUID) async throws -> DocumentEntity? {
        let descriptor = FetchDescriptor<SDDocument>(
    ...
    public func create(_ entity: DocumentEntity) async throws {
    ...
    public func update(_ entity: DocumentEntity) async throws {
        let id = entity.id
        let descriptor = FetchDescriptor<SDDocument>(
            predicate: #Predicate { $0.id == id }
        )
    ...
    public func fetchForTransaction(_ transactionID: UUID) async throws -> [DocumentEntity] {
...
@MainActor
public final class EncryptedDocumentRepository: DocumentRepository, Sendable {
