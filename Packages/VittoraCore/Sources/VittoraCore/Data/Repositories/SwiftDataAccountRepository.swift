...
public actor SwiftDataAccountRepository: AccountRepository {
    public func fetchAll() async throws -> [AccountEntity] {
    ...
    public func fetchActive() async throws -> [AccountEntity] {
        let descriptor = FetchDescriptor<SDAccount>(
    ...
    public func fetchByID(_ id: UUID) async throws -> AccountEntity? {
        let descriptor = FetchDescriptor<SDAccount>(
    ...
    public func create(_ entity: AccountEntity) async throws {
        let model = SDAccount(
            id: entity.id,
            name: entity.name,
            type: entity.type,
    ...
    public func update(_ entity: AccountEntity) async throws {
        let id = entity.id
        let descriptor = FetchDescriptor<SDAccount>(
            predicate: #Predicate { $0.id == id }
        )
    ...
    public func fetchByType(_ type: AccountType) async throws -> [AccountEntity] {
