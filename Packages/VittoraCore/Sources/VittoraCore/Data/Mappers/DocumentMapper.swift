...
public enum DocumentMapper {
    public nonisolated static func toEntity(_ model: SDDocument) -> DocumentEntity {
        DocumentEntity(
            id: model.id,
    ...
    public nonisolated static func updateModel(_ model: SDDocument, from entity: DocumentEntity) {
...
@MainActor
public final class EncryptedDocumentStorageService: DocumentStorageServiceProtocol, Sendable {
    ...
    public func saveDocument(_ data: Data, for entity: DocumentEntity) async throws {
    ...
    public func loadDocument(for entity: DocumentEntity) async throws -> Data {
    ...
    public func deleteDocument(for entity: DocumentEntity) async throws {
        try removeItemIfPresent(at: secureURL(for: entity.id, kind: .document))
        try removeItemIfPresent(at: legacyDocumentURL(for: entity.fileName))
    }

    public func saveThumbnail(_ data: Data, for documentID: UUID) async throws {
        try ensureSecureDirectoryExists()
        let encryptedData = try await encryptionService.encrypt(data)
    ...
    public func loadThumbnail(for documentID: UUID) async throws -> Data? {
    ...
    public func deleteThumbnail(for documentID: UUID) async throws {
