...
public enum AccountMapper {
    public nonisolated static func toEntity(_ model: SDAccount) -> AccountEntity {
        AccountEntity(
            id: model.id,
            name: model.name,
            type: model.type,
    ...
    public nonisolated static func updateModel(_ model: SDAccount, from entity: AccountEntity) {
