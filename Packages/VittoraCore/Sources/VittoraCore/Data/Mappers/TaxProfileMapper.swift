...
public enum TaxProfileMapper {
    public nonisolated static func toEntity(_ model: SDTaxProfile) -> TaxProfile {
        TaxProfile(
            id: model.id,
    ...
    public nonisolated static func updateModel(_ model: SDTaxProfile, from entity: TaxProfile) {
