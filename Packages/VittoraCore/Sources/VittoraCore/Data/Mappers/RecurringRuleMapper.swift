...
public enum RecurringRuleMapper {
    public nonisolated static func toEntity(_ model: SDRecurringRule) -> RecurringRuleEntity {
        RecurringRuleEntity(
            id: model.id,
    ...
    public nonisolated static func updateModel(_ model: SDRecurringRule, from entity: RecurringRuleEntity) {
