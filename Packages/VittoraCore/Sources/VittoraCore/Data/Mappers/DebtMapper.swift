...
public enum DebtMapper {
    ...
    public nonisolated static func linkedTransactionIDs(from model: SDDebt) -> [UUID] {
    ...
    public nonisolated static func toEntity(_ model: SDDebt) -> DebtEntry {
        DebtEntry(
            id: model.id,
    ...
    public nonisolated static func updateModel(_ model: SDDebt, from entity: DebtEntry) {
