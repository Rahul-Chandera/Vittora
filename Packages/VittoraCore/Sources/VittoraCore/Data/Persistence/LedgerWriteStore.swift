...
public enum LedgerWriteError: LocalizedError, Sendable {
...
@ModelActor
public actor LedgerWriteStore: LedgerWriting {
    ...
    public func commit(_ work: @Sendable (ModelContext) throws -> Void) throws {
        do {
    ...
    public func performAdd(_ transaction: TransactionEntity) throws {
    ...
    /// diverge.
    public func performSettle(debtID: UUID, settlementAmount: Decimal, transaction: TransactionEntity?) throws {
        try commit { ctx in
    ...
    public func performUpdate(_ transaction: TransactionEntity) throws {
        guard transaction.type != .transfer else {
            throw LedgerWriteError.transferNotSupported
        }
        try commit { ctx in
    ...
    public func performUpdateTransfer(
        transferPairID: UUID,
        sourceAccountID: UUID,
        destinationAccountID: UUID,
        amount: Decimal,
    ...
    public func performDeleteCategory(categoryID: UUID) throws {
        try commit { ctx in
    ...
    public func performDeleteRecurringRule(ruleID: UUID) throws {
        try commit { ctx in
