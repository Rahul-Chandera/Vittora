...
extension VittoraSchemaV7 {
    /// Frozen transaction shape for Schemas V3–V7 — everything before the V8
    /// category-suggestion column. V3 added `transferDirectionRawValue` and the
    /// shape then held steady through V7.
    @Model
